def call(def abortOnQualityGateFailure = false, def abortPipeline = false) {
    ...
    timeout(time: 5, unit: 'MINUTES') {
        def qualityGateStatus = sh(script: 'curl -u [![Quality Gate Status]sqb_d093caf346a02a6bf951405197b5514836b0c15c)]
        http://localhost:9000/api/qualitygates/project_status?projectKey=DevOps_practica2', 
